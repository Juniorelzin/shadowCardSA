...
function TelaBatalha() {
    ...
    const cartasOriginaisJogador = [
        { id: 1, deckId: 1, imagem: "./src/assets/images/Carta de esqueleto 1.png", nome: "Boss", descricao: "Destruidor", atk: 85, def: 70 },
        { id: 2, deckId: 1, imagem: "./src/assets/images/Carta de esqueleto 2.png", nome: "Boss", descricao: "Usa espada", atk: 55, def: 45 },
        { id: 3, deckId: 1, imagem: "./src/assets/images/Carta de esqueleto 3.png", nome: "Barricade", descricao: "é verde", atk: 90, def: 80 },
        { id: 4, deckId: 1, imagem: "./src/assets/images/Carta de esqueleto 4.png", nome: "Barricade", descricao: "Usa arco", atk: 70, def: 60 },
        { id: 5, deckId: 1, imagem: "./src/assets/images/Carta de esqueleto 5.png", nome: "Barricade", descricao: "protege", atk: 95, def: 80 }
    ];

    const cartasOriginaisOponente = [
        { id: 1, deckId: 1, imagem: "./src/assets/images/Carta de goblin 1.png", nome: "esqueleto", descricao: "osso", atk: 65, def: 30 },
        { id: 2, deckId: 1, imagem: "./src/assets/images/Carta de goblin 2.png", nome: "esqueleto", descricao: "7 cabeças", atk: 40, def: 45 },
        { id: 3, deckId: 1, imagem: "./src/assets/images/Carta de goblin 3.png", nome: "esqueleto", descricao: "torre", atk: 70, def: 35 },
        { id: 4, deckId: 1, imagem: "./src/assets/images/Carta de goblin 4.png", nome: "cachorro", descricao: "é cinza", atk: 65, def: 20 },
        { id: 5, deckId: 1, imagem: "./src/assets/images/Carta de goblin 5.png", nome: "cachorro", descricao: "late", atk: 80, def: 50 }
    ];
